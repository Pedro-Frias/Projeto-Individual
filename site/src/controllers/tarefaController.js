...
function listarPorUsuario(req, res) {
    ...
    tarefaModel.listarPorUsuario(idUsuario)
        .then(
            function (resultado) {
                if (resultado.length > 0) {
                    res.status(200).json(resultado);
...
function pesquisarDescricao(req, res) {
    ...
    tarefaModel.pesquisarDescricao(descricao)
        .then(
            function (resultado) {
                if (resultado.length > 0) {
                    res.status(200).json(resultado);
...
function publicar(req, res) {
    ...
    if (titulo == undefined) {
        ...
        tarefaModel.publicar(titulo,data, descricao,idUsuario,atividade)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function editar(req, res) {
    ...
    tarefaModel.editar(novaDescricao, idTarefa)
        .then(
            function (resultado) {
                res.json(resultado);
            }
